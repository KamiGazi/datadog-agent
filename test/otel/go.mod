...
require go.opentelemetry.io/collector/extension/xextension v0.152.0 // indirect

require go.opentelemetry.io/collector/extension/extensionauth v1.58.0 // indirect

require go.opentelemetry.io/collector/config/configoptional v1.58.0 // indirect
