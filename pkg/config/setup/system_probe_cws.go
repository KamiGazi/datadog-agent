...
func initCWSSystemProbeConfig(cfg pkgconfigmodel.Setup) {
	...
	cfg.BindEnvAndSetDefault("runtime_security_config.syscall_events.enabled", false)
	cfg.BindEnvAndSetDefault("runtime_security_config.syscall_events.period", "60s")
