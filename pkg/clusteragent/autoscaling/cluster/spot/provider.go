...
func StartSpotScheduling(ctx context.Context, wlm workloadmeta.Component, apiCl *apiserver.APIClient, isLeaderFunc func() bool, senderManager sender.SenderManager, taggerComp tagger.Component) (PodHandler, error) {
	if apiCl == nil {
